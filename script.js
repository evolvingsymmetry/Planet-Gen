...
function planetTag(){
  document.getElementById("planettag").innerHTML = arrSearch(tags);
}
...
function getRandomCharacteristic(){
    ...
    if(planetsizeChoice == "Asteroid") {
        document.getElementById("characteristic").innerHTML = randomEl(asteroids_Char);
    }
    if(planetsizeChoice == "Asteroid") {
        document.getElementById("atmosphere").innerHTML = randomEl(asteroids_Atmo);
    }
    if(planetsizeChoice == "Asteroid") {
        document.getElementById("biosphere").innerHTML = randomEl(asteroids_Bios);
    }
    if(planetsizeChoice == "Asteroid") {
        document.getElementById("population").innerHTML = randomEl(asteroids_Popu);
    }


    //Planet
    if(planetsizeChoice == "Planet") {
        document.getElementById("characteristic").innerHTML = randomEl(planet_Char);
    }
    if(planetsizeChoice == "Planet") {
        document.getElementById("atmosphere").innerHTML = randomEl(planet_Atmo);
    }
    if(planetsizeChoice == "Planet") {
        document.getElementById("biosphere").innerHTML = randomEl(planet_Bios);
    }
    if(planetsizeChoice == "Planet") {
        document.getElementById("population").innerHTML = randomEl(planet_Popu);
    }
